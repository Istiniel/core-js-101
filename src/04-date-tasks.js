...
function timeSpanToString(startDate, endDate) {
  ...
  const minutes = Math.floor((elapsedTime - hours * 3600 * 1000) / (1000 * 60));
  const seconds = Math.floor(
    (elapsedTime - minutes * 60 * 1000 - hours * 3600 * 1000) / 1000,
  );
  const mSeconds = Math.floor(
    elapsedTime - minutes * 60 * 1000 - hours * 3600 * 1000 - seconds * 1000,
  );

  return `${String(hours).padStart(2, 0)}:${String(minutes).padStart(
    2,
    0,
  )}:${String(seconds).padStart(2, 0)}.${String(mSeconds).padStart(3, 0)}`;
}
